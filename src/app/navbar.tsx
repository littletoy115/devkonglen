                    ...
                    <div className="relative flex h-16 items-center justify-between">
                        ...
                        <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                            <div className="flex flex-shrink-0 items-center">
                                ...
                                <Image width={0} height={0} className="hidden h-8 w-auto lg:block" src="/logo.png" alt="Your Company"></Image>
                            </div>
                            ...
                            <div className="relative ml-3">
                                <div>
                                    <button type="button" onClick={() => handleClick(true)} className="flex rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                                        ...
                                        {/* <Image width={0} height={0} className="h-8 w-8 rounded-full" src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" alt=""></Image> */}
                                    </button>
                                </div>
